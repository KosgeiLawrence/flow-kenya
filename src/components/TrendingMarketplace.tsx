    ...
    <section className="relative py-20 md:py-32 overflow-hidden">
      ...
      <div className="container relative z-10">
        <div className="mb-12 text-center">
          ...
          >
            Circular Economy <span className="text-gradient-gold">Marketplace</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Browse waste materials, recycled products, and equipment from verified sellers across Kenya — all in one marketplace.
          </motion.p>
        </div>
