...
const workflows: Workflow[] = [
  ...
  },
  {
    ...
    steps: [
      { label: "List Materials", description: "Post available materials with quantity and asking price", icon: Store, color: "bg-accent/10 text-accent" },
      { label: "Receive Inquiries", description: "Recyclers and buyers will contact you for materials", icon: Users, color: "bg-accent/10 text-accent" },
      { label: "Generate Invoice", description: "Create an invoice for the agreed sale", icon: FileText, color: "bg-accent/10 text-accent" },
      { label: "Arrange Logistics", description: "Coordinate pickup or delivery of materials", icon: Truck, color: "bg-accent/10 text-accent" },
    ],
  },
  {
    id: "payments",
  ...
  },
  {
    ...
    steps: [
      { label: "View Income", description: "Track money received from selling materials to recyclers", icon: TrendingUp, color: "bg-accent/10 text-accent" },
      { label: "Add Expenses", description: "Record costs like transport, storage, wages, and equipment", icon: FileText, color: "bg-accent/10 text-accent" },
      { label: "Set Budgets", description: "Set monthly spending limits for different categories", icon: BarChart3, color: "bg-accent/10 text-accent" },
      { label: "Download Reports", description: "Get Profit & Loss, Cash Flow, and Balance Sheet reports", icon: ClipboardList, color: "bg-accent/10 text-accent" },
    ],
  },
  {
    id: "logistics",
  ...
  },
  {
    ...
    steps: [
      { label: "Upload Documents", description: "Add business licenses, environmental permits, and certificates", icon: Shield, color: "bg-accent/10 text-accent" },
      { label: "Track EPR Progress", description: "Monitor your Extended Producer Responsibility targets", icon: Leaf, color: "bg-accent/10 text-accent" },
      { label: "ESG Reports", description: "Generate environmental, social, and governance reports", icon: BarChart3, color: "bg-accent/10 text-accent" },
      { label: "Carbon Offset", description: "See how much CO₂ your collections help avoid", icon: Leaf, color: "bg-accent/10 text-accent" },
    ],
  },
];
...
const OverviewDiagram = () => {
  const mainFlow = [
    ...
    { label: "Sort & Aggregate", icon: ClipboardList, color: "bg-accent/10 text-accent" },
    { label: "Sell to Recyclers", icon: Store, color: "bg-accent/10 text-accent" },
