...
const workflows: Workflow[] = [
  ...
  },
  {
    ...
    steps: [
      { label: "Select Raw Material", description: "Choose waste material from your inventory (e.g., PET bottles)", icon: Package, color: "bg-accent/10 text-accent" },
      { label: "Set Input Quantity", description: "Enter how much material you want to process (e.g., 100 kg)", icon: CircleDot, color: "bg-accent/10 text-accent" },
      { label: "Choose Output", description: "Name your product (e.g., 'Recycled Pellets') or add to existing product", icon: Recycle, color: "bg-accent/10 text-accent" },
      { label: "Record Transformation", description: "System deducts raw material, creates product, and tracks yield", icon: CheckCircle2, color: "bg-accent/10 text-accent" },
    ],
  },
  {
    id: "sales",
  ...
  },
  {
    ...
    steps: [
      { label: "Sales Auto-Recorded", description: "When you sell a product, income is logged automatically", icon: TrendingUp, color: "bg-accent/10 text-accent" },
      { label: "Add Expenses", description: "Record costs like transport, labor, or electricity", icon: FileText, color: "bg-accent/10 text-accent" },
      ...
      { label: "Download Reports", description: "Get Profit & Loss, Cash Flow, and Balance Sheet reports", icon: ClipboardCheck, color: "bg-accent/10 text-accent" },
    ],
  },
  {
    id: "crm",
  ...
  },
  {
    ...
    steps: [
      ...
      { label: "Track Carbon Offset", description: "See how much CO₂ your recycling prevents automatically", icon: Leaf, color: "bg-accent/10 text-accent" },
...
const OverviewDiagram = () => {
  const mainFlow = [
    ...
    { label: "Transform / Recycle", icon: Recycle, color: "bg-accent/10 text-accent" },
    { label: "Create Products", icon: ShoppingBag, color: "bg-accent/10 text-accent" },
